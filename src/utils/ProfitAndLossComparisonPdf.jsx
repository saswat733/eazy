...
const ProfitAndLossComparisonDownloadPDF = ({ data, companyName, dateFormat, size, username }) => {
  ...
  function generateComparisonPDF() {
    ...
    // Header Section
    doc.setFontSize(8);
    doc.text(`Report run by ${username} at ${new Date().toLocaleString('en-GB')}`, 
            pageWidth - rightMargin, 10, { align: "right" });
    ...
    doc.setFontSize(16);
    doc.text("Profit and Loss Comparison", pageWidth / 2, currentY, { align: "center" });
    currentY += 10;
    ...
    doc.save('profit_and_loss_comparison.pdf');
  }
...
export default ProfitAndLossComparisonDownloadPDF;
